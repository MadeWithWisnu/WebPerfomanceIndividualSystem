...
namespace WebPerfomanceIndividualSystem.Models;

public partial class PerformanceAppsContext : DbContext
{
    public PerformanceAppsContext()
    {
    }

    public PerformanceAppsContext(DbContextOptions<PerformanceAppsContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Anuallycompetence>(entity =>
        {
            ...
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.Property(e => e.WorkmainindicatorId).HasColumnName("workmainindicator_id");
            ...
            entity.HasOne(d => d.Workmainindicator).WithMany(p => p.Anuallycompetences)
                .HasForeignKey(d => d.WorkmainindicatorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("anuallycompetences_workmainindicator_id_fkey");
        });
